    ...
    <div class="container">
        <div class="row my-5">
            <div class="col text-center">
                @if ($total > 1)
                    <h2 class="text-white w-25 rounded m-auto mb-2"><i class="fa fa-user"></i> {{$total}} users</h2>
                @else
                    <h2 class="text-white w-25 rounded m-auto mb-2"><i class="fa fa-user"></i> {{$total}} user</h2>
                @endif
            </div>
        </div>
