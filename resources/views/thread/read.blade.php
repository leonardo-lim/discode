            ...
            @foreach ($threads as $thread)
                <div class="col-xl-4 col-md-6">
                    <div class="card p-0 mb-5 border-0" style="height: 300px">
                        ...
                        <a href="" class="btn btn-warning text-white" style="position: absolute; top: -10px; right: 28px"><i class="fa fa-edit"></i></a>
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="row mt-auto m-0">
                                ...
                                <div class="col-4 p-0">
                                    <button class="btn btn-info text-white w-100" title="Comment"><i class="fa fa-comment" aria-hidden="true"></i> 1</button>
                                </div>
                            </div>
                            <div class="tags">
                            </div>
